...
const Footer = () => {
  return (
    <div className="w-full z-10 bg-cdark border-t border-t-csecondary h-[80px] mt-32">
      <div className="max-w-[1040px] mx-auto w-full h-full">
        <div className="flex items-center justify-between w-full h-full">
          ...
          <div className="flex gap-8 items-center">
            <a href="https://www.facebook.com/tamkart.az/" target="_blank">
              <img src={facebook} alt="abb" />
            </a>
            <a href="https://www.instagram.com/tamkart.az/" target="_blank">
