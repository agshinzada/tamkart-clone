    ...
    <section className="max-w-[1040px] mx-auto flex flex-col items-center px-4 tablet:px-10 laptop:px-0">
      <div className="tablet:hidden relative w-[510px] h-[250px]  tablet:h-[316px]">
        <img
          ...
          alt="card"
          className="w-[280px] absolute bottom-5 left-20 transition-all duration-500 z-10 laptop:hidden block"
        />
        <img
          src="https://tamkart.az/_next/static/media/tampremiumvisa.fd5fe401.png"
          alt="card"
          className="w-[280px] absolute top-0 right-20 transition-all duration-500 laptop:hidden block"
        />
      </div>
